      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Sky<span className="text-blue-400">Race</span></h3> 
            <p className="mb-4">
              Making travel simple, affordable, and accessible for everyone around the world.
            </p>
        ...
        <div className="mb-8 md:w-[500px]">
          <h4 className="text-white font-semibold text-lg mb-4">Subscribe to our Newsletter</h4>
          <div className="flex flex-col sm:flex-row gap-2">
            <input 
              type="email" 
              placeholder="Your email address" 
              className="flex-grow px-4 py-2 rounded bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
